<template>
  <div class="contain">
    <categoria v-for="categoria in categorias" :key="categoria.id" :title="categoria.titulo" :filmes="categoria.filmes"/>
  </div>
</template>

<script>

// import testTeck from './components/teste';
...
export default {
  ...
  data () {
    return {
      nameProject: 'NetFlix Com Vue.js',
      intervalo: null,
      categorias: []
    }
  }
